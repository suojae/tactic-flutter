...
abstract class AdminApiService {
  ...
  @GET("/duplicate")
  Future<CheckDuplicateAdminResponseDto> checkDuplicateAdmin(
      @Body() CheckDuplicateAdminRequestDto request);
  ...
  Future<BaseResponseDto<void>> sendSignupCode(
      @Body() SendCodeRequestDto request);

  @POST("/signup/verifyCode")
  Future<BaseResponseDto<void>> verifySignupCode(
      @Body() VerifyCodeRequestDto request);

  @PUT("/signup/complete")
  Future<CompleteSignupResponseDto> completeSignUp(
